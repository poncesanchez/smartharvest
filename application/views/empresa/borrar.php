...
<section class="content-header">
  <h1><i class="fa fa-building"></i> Borrar <strong><?php echo $empresa['nombre']?></strong></h1>
  <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-6 col-sm-6 col-xs-12">
      <div class="box box-danger">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?=form_open('empresas/borrar/'.$empresa['idempresa'])?>
        <div class="box-body">
          <h4>Estas apunto de eliminar todos los registros relacionados a la empresa <strong><?php echo $empresa['nombre']?></strong>.</h4>
