...
<section class="content-header">
  <h1><i class="fa fa-users"></i> Crear trabajador</h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Nuevo Trabajador</h3>
        </div>
        <?=form_open('empresas/crear/'.$idEmpresa)?>
        <div class="box-body">
          <div class="row">
            <div class="form-group col-xs-3">
              <?=form_label('Nombre','nombre')?>
              <?=form_input(array('name'=>'nombre','class'=>'form-control','required'=>'required','value'=>set_value('nombre',$persona['nombre'])))?>
            </div>
            <div class="form-group col-xs-3">
              <?=form_label('Apellido paterno','Apellido paterno')?>
              <?=form_input(array('name'=>'apellidopaterno','class'=>'form-control','required'=>'required','value'=>set_value('nombre',$persona['apellidopaterno'])))?>
            </div>
            <div class="form-group col-xs-3">
            ...
            <div class="form-group col-xs-3">
              ...
              <div class="row">
                <div class="col-xs-9">
                  <?=form_input(array('name'=>'rut','class'=>'form-control','required'=>'required', 'value'=>set_value('nombre',$persona['rut'])))?>
                </div>
                <div class="col-xs-3">
                  <?=form_input(array('name'=>'dv','class'=>'form-control','required'=>'required','value'=>set_value('nombre',$persona['dv'])))?>
                </div>
              </div>
            </div>
          </div>
