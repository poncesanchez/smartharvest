              ...
              <li class="empresa-item">
                <div class="row">
                  <div class="col-md-9 item-description text-left">
                    <h4><a href="<?=site_url()?>/empresas/home/<?=$empresa->idempresa?>"><?=$empresa->nombre?></a>
                  ...
                  <div class="col-md-3 pt-20 pull-right text-right">
                    <a class="btn-sm btn-primary" role="button" href="<?=site_url()?>/empresas/home/<?=$empresa->idempresa?>">
